...
public class JanelaRelatorioCompradores extends JFrame {
    ...
    public JanelaRelatorioCompradores(ACMETech sistema) {
        super("Relatório de Compradores");
    ...
    private void carregarRelatorio() {
        String rel = sistema.relatorioCompradores();
